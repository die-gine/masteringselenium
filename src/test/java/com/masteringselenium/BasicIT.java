...
public class BasicIT extends DriverBase {
    ...
    @Test
    public void googleMuhExample() {
        googleExampleThatSearchesFor("Muh!");
    }

    @Test
    public void googleHelloExample() {
        googleExampleThatSearchesFor("Hello!");
    }
    @Test
    public void googleByexample() {
        googleExampleThatSearchesFor("Bye!");
    }
}